...
function capturar() {
    let capt = document.querySelector("#resposta").value;
    document.querySelector('.valorDigitado').innerHTML = capt;
    if (valorDigitado === resultado) {
        capt.innerHTML += `<p>Parabéns! Você acertou!</p>`
    } else {
        capt.innerHTML += `<p>("Errado!Tente novamente")</p>`
    }
